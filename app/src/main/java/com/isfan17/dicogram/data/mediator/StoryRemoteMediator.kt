package com.isfan17.dicogram.data.mediator
...
import com.isfan17.dicogram.utils.Constants.Companion.INITIAL_PAGE_INDEX
...
class StoryRemoteMediator (
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getAllStories(token = token, page = page, size = state.config.pageSize).listStory
